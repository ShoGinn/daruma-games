...
} from '../../mocks/djs-mock/channel-mock.js';
...
describe('Forum Channel Mock', () => {
	it('should create a forum channel', () => {
		...
		expect(
			forumChannel.guild.channels.cache.get(forumChannel.id),
		).toBeDefined();
...
describe('Thread Mock', () => {
	it('should create a thread channel', () => {
		...
		expect(
			threadChannel.guild.channels.cache.get(threadChannel.id),
		).toBeDefined();
	...
	it('should create a thread channel with a parent channel', () => {
		const textChannel = mockTextChannel(client);
		const threadChannel = mockPublicThread({
			client,
	...
	it('should create a thread with a parent message', () => {
		...
		const threadChannel = mockThreadFromParentMessage({
			client,
