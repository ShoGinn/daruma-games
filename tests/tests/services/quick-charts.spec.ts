...
import { DarumaTrainingEncountersRepository } from '../../../src/database/dt-encounter/dt-encounters.repo.js';
...
import { QuickChartsService } from '../../../src/services/quick-charts.js';
import { mockCustomCache } from '../../mocks/mock-custom-cache.js';

jest.mock('../../../src/database/dt-encounter/dt-encounters.repo.js');
describe('QuickChartsService', () => {
  let service: QuickChartsService;
  let dtEncountersService: DarumaTrainingEncountersService;
  let mockedDtEncountersRepo: jest.Mocked<DarumaTrainingEncountersRepository>;
  beforeEach(() => {
    mockedDtEncountersRepo =
      new DarumaTrainingEncountersRepository() as jest.Mocked<DarumaTrainingEncountersRepository>;
    dtEncountersService = new DarumaTrainingEncountersService(mockedDtEncountersRepo);
  ...
  describe('generateEncounterData', () => {
    ...
    describe('darumaGameDistributionsPerGameType', () => {
      ...
      test('should return the null when encounter data is not provided', async () => {
        mockedDtEncountersRepo.getAll = jest.fn().mockImplementationOnce(() => {
          return [];
        });
    ...
    describe('getRoundsDistributionPerGameTypeData', () => {
      ...
      test('should return expected result', async () => {
        ...
        const result = await service.getRoundsDistributionPerGameTypeData();
        expect(result).toEqual(expected);
        expect(mockedDtEncountersRepo.getAll).toHaveBeenCalledTimes(1);
      });
